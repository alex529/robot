...
#define set_lf()	{mot_left_port1	|=(1<<mot_left_forw); mot_left_port &=~(1<<mot_left_back);l_motor.m_dir = FORWARD;l_motor.breaking = OFF;}
#define set_lb()	{mot_left_port	|=(1<<mot_left_back); mot_left_port1 &=~(1<<mot_left_forw);l_motor.m_dir = BACKWARD;l_motor.breaking = OFF;}
...
#define set_ls()	{mot_left_port	|=(1<<mot_left_back); mot_left_port1 |=(1<<mot_left_forw);l_motor.breaking = OFF;set_left_m(0);}
#define set_ld()	{mot_left_port	|=(1<<mot_left_back); mot_left_port1 |=(1<<mot_left_forw);l_motor.breaking = OFF;}
...
#define set_rd()	{mot_right_port	|=(1<<mot_right_forw); mot_right_port|=(1<<mot_right_back);r_motor.breaking = OFF;}
